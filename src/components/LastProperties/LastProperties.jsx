...
import './LastProperties.scss';
import ProperyCard from '../ProperyCard/ProperyCard';

const LastProperties = () => {
    return (
        <div className="last-properties">
            <div className="last-properties-title">
                <Typography variant='h4' fontWeight='bold'>اخرین ملک ها</Typography>
